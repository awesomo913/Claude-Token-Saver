...
- **Windows exe:** `dist/ClaudeTokenSaver/ClaudeTokenSaver.exe`. After `build_exe.py`, a copy is deployed to `Desktop/My Apps/ClaudeTokenSaver/` (per workspace EXE Packaging Rule).
