"""GitHub App Installer — standalone GUI for managing project context.
...
your project WITHOUT you opening the GitHub App Installer GUI.
...
That's the 5x compression (pre-loaded context) this app always
...
class TokenSaverApp(ctk.CTk):
    def __init__(self) -> None:
        ...
        self.title("GitHub App Installer")
    ...
    def _build_ui(self) -> None:
        ...
        ctk.CTkLabel(sb, text="GitHub App Installer", font=(F, 16, "bold"),
    ...
    def _gen_report(self) -> None:
        ...
        def do():
            ...
            lines.append("")
            lines.append("=" * 50)
            lines.append("Generated by GitHub App Installer v4.5")
